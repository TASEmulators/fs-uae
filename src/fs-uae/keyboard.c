...
static fs_emu_key_translation g_default_keymap[] = {
    ...
    { FS_ML_KEY_KP0,          MOD, INPUTEVENT_SPC_EFLOPPY0 },
    { FS_ML_KEY_KP1,          MOD, INPUTEVENT_SPC_EFLOPPY1 },
    { FS_ML_KEY_KP2,          MOD, INPUTEVENT_SPC_EFLOPPY2 },
    { FS_ML_KEY_KP3,          MOD, INPUTEVENT_SPC_EFLOPPY3 },
    { FS_ML_KEY_0,            MOD, INPUTEVENT_SPC_DISKSWAPPER_INSERT0 },
    { FS_ML_KEY_1,            MOD, INPUTEVENT_SPC_DISKSWAPPER_INSERT1 },
    { FS_ML_KEY_2,            MOD, INPUTEVENT_SPC_DISKSWAPPER_INSERT2 },
    { FS_ML_KEY_3,            MOD, INPUTEVENT_SPC_DISKSWAPPER_INSERT3 },
    { FS_ML_KEY_PAGEDOWN,     MOD, INPUTEVENT_SPC_DISKSWAPPER_NEXT },
    { FS_ML_KEY_PAGEUP,       MOD, INPUTEVENT_SPC_DISKSWAPPER_PREV },
#if 0
